-- hi yeah i am going insane trying to port all of the prototype code to something usable. help me.
...
track_definitions = {
	{
		...
		zones_texture = "mods/evaisa.kart/files/textures/map-noita-checkpoint-zones.png",
		nodes_texture = "mods/evaisa.kart/files/textures/map-noita-ai-nodes-2.png",
